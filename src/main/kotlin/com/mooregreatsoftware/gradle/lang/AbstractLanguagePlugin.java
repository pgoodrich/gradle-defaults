...
public abstract class AbstractLanguagePlugin implements Plugin<Project> {
    ...
    protected static void configureLanguageTasks(Project project) {
        project.getTasks().withType(Jar.class, jarTask ->
            jarTask.doFirst(task -> setManifestAttributes(jarTask.getProject()))
        );
    ...
    private static void setManifestAttributes(Project project) {
        project.getLogger().debug("Setting MANIFEST.MF attributes");
        configureManifestAttributes(project, jarTask(project));
    }


    private static void configureManifestAttributes(Project project, Jar jarTask) {
        val attrs = manifestAttributes(project);
    ...
    public final void apply(Project project) {
        ...
        project.getLogger().info("Applying {} to {}", pluginId(), project);
