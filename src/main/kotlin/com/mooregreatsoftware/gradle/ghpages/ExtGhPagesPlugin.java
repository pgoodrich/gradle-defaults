...
public class ExtGhPagesPlugin implements Plugin<Project> {
    ...
    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(ExtGhPagesPlugin.class);
    ...
    private void configKotlin(Project project) {
        ...
        project.afterEvaluate(p -> {
            if (!project.getPlugins().hasPlugin("org.jetbrains.dokka")) {
                project.getLogger().warn("Using the Kotlin plugin, but Dokka is not being used for API documentation");
            }
        });
    }
